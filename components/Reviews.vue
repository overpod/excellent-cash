...
const reviews = [
  {
    ...
    city: 'Воронеж',
    text:
      'Так уж получилось, что офис компании “Отличные наличные” находился по дороге на работу и жизненные проблемы моей жены, завели меня в эту компанию. Я к ним пришёл с одной целью, мне срочно нужны были деньги. В итоге свои 5000 рублей я получил за 20 минут потраченного времени. Ни в одном банке мне бы так быстро, даже карту не выписали (а из документов у меня только паспорт был). По поводу процентов ничего не скажу, т. к. займ я закрыл через 3 дня.',
  },
  {
    id: 2,
